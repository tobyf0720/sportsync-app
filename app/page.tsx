...
function SocialPage({ setActiveNav }: { setActiveNav: (nav: string) => void }) {
  ...
  const posts = [
    ...
    { id: 4, user: 'Jake M.', handle: '@jakем', sport: 'Football', sportColor: '#22c55e', emoji: '⚽', time: '2 days ago', caption: 'Sunday league season starts next week. Can\'t wait. The lads are looking sharp in training.', likes: 18, comments: 4, hasMedia: false, mediaBg: '' },
  ]
